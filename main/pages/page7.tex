...
AI, dron, poľnohospodárstvo, presné poľnohospodárstvo, multispektrálne snímanie, edge computing, TRL 4–6, Green Deal, Copernicus, udržateľnosť  \\
...
1) Zvýšiť presnosť detekcie o $\geq20$ \% oproti existujúcim riešeniam pomocou fúzie dát z Copernicus a lokálnych senzorov.  \\
...
1) Increase detection accuracy by $\geq20$ \% using Copernicus + local sensor fusion.  \\
